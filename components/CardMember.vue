...
import { PhLinkedinLogo, PhGithubLogo, PhEnvelopeOpen } from "@phosphor-icons/vue";
...
<template>
  <div class="grid gap-4 w-60 h-[18.5rem] justify-items-center border-2 px-4 py-6 border-accent-primary rounded-lg">
